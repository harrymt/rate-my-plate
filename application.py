...
def get_recipe_breakdown():
    ...
    country_codes = get_country_codes(producers)
    return render_template("index.html", recipe=recipe_name, ingredients=ingredients, producers=producers, locations=country_codes)
...
def get_country_codes(producers):
    locations = []
